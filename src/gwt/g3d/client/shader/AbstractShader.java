...
public abstract class AbstractShader implements Shader {
	...
	protected final void initProgram(String vertexSource, String fragmentSource) 
      ...
      throw new ShaderException("Could not initialise shaders: " + gl.getProgramInfoLog(program));
    }		
	}
	...
	protected final WebGLShader loadShader(String shaderSource, 
		...
		if (!gl.getShaderParameterb(shader, ShaderParameter.COMPILE_STATUS)) {
			throw new ShaderException("Shader compiling error: " + gl.getShaderInfoLog(shader));
		}
		return shader;
	}
	...
	public void setNamedTexture(TextureUnit textureUnit, String name) {
		gl.uniform1i(getUniformLocation(name), 
